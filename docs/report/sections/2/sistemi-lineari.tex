...
\begin{definition}
    ...
    possibili per il sistema per i sistemi che evolvono secondo l'equazione di Newton della meccanica.
\end{definition}
...
\footnotetext{%
        Augustin-Louis Cauchy (1789 - 1857) è stato un matematico e ingegnere francese. Ha avviato il progetto della formulazione e dimostrazione rigorosa dei teoremi dell’analisi infinitesimale e Ha dato anche importanti contribuiti alla teoria delle funzioni di variabile complessa e alla teoria delle equazioni differenziali. Il lavoro che ha svolto
