...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{assets/pendolo-down}}
    %todo
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=.5\textwidth]{docs/report/assets/dettaglio-carrello}}
    %todo
    \caption[todo]{tood}
...
\begin{figure}[h]
    \centering
    \fbox{\includegraphics[width=.8\textwidth]{docs/report/assets/angle-sensor}}
    %todo
    \caption[todo]{tood}
