...
la posso usare come costo al posto della matrice $Q$,
...
sono costretto ad introdurre un \emph{potenziale fittizio}
$q_{11} > 0$ per far sì che il sistema tenda allora
stato dove $q = 0$.
$R$ va scelto in base alla forza massima che può sopportare
il motore.
Per ora fisso $R = (r_{11})$ con $r_{11} > 0$.
